...
export const BADGES = [
  {
    id: "first_charge",
    name: "First Charge",
    icon: require("../../assets/badges/trophy.png"),
    completionCriteria: 1,
    expValue: 50,
    secret: false,
    excludes: [],
    desc: "Completed your very first workout at the Toldo Lancer Centre.",
  },
  {
    id: "iron_week",
    name: "Iron Week",
    icon: null,
    completionCriteria: 7,
    expValue: 100,
    secret: false,
    excludes: [],
    desc: "Hold a 7-day check-in streak without breaking formation.",
  },
  {
    id: "dawn_patrol",
    name: "Dawn Patrol",
    ...
    secret: false,
    excludes: [],
    desc: "Log 5 workouts before 8:00 AM. The campus was still asleep.",
  },
  {
    id: "pool_shark",
    name: "Pool Shark",
    ...
    secret: false,
    excludes: [],
    desc: "Swim 100 total lengths in the Toldo pool.",
  },
  {
    id: "squad_captain",
    name: "Squad Captain",
    ...
    secret: false,
    excludes: [],
    desc: "Recruit 3 friends who each complete their first workout.",
  },
  {
    id: "tower_conqueror",
    ...
    secret: false,
    excludes: [],
    desc: "Climb 50 floors in a single Tower Challenge.",
  },
  {
    id: "frost_lancer",
    name: "Frost Lancer",
    ...
    secret: false,
    excludes: [],
    desc: "Check in 10 times during exam season. Respect.",
  },
  {
    id: "new_heights",
    name: "New Heights",
    ...
    secret: false,
    excludes: [],
    desc: "Log a personal record on any tracked lift.",
  },
  {
    id: "semester_strong",
    ...
    secret: false,
    excludes: [],
    desc: "Stay active every single week of the semester.",
  },
  {
    id: "century_club",
    name: "Century Club",
    ...
    secret: false,
    excludes: [],
    desc: "Log 100 lifetime workouts. The gold standard.",
  },
  {
    id: "night_watch",
    name: "Night Watch",
    ...
    secret: false,
    excludes: [],
    desc: "Log 10 workouts after 9:00 PM. The arena never sleeps.",
  },
  {
    id: "the_gauntlet",
    name: "The Gauntlet",
    ...
    secret: false,
    excludes: [],
    desc: "Finish 5 featured challenges in one season.",
  },
  // Mutually exclusive competition placement badges
  {
    id: "gold_lancer",
    name: "Gold Lancer",
    icon: null,
    ...
    expValue: 750,
    secret: false,
    excludes: ["silver_lancer", "bronze_lancer"],
    desc: "Finished 1st in a faculty fitness competition.",
  },
  {
    id: "silver_lancer",
    name: "Silver Lancer",
    ...
    expValue: 500,
    secret: false,
    excludes: ["gold_lancer", "bronze_lancer"],
    desc: "Finished 2nd in a faculty fitness competition.",
  },
  {
    id: "bronze_lancer",
    name: "Bronze Lancer",
    ...
    expValue: 300,
    secret: false,
    excludes: ["gold_lancer", "silver_lancer"],
    desc: "Finished 3rd in a faculty fitness competition.",
  },
];

// "user_badges" table — one row per badge the user has interacted with.
// completedAt is only present on fully earned rows.
export const USER_BADGES = [
  {
    userID: "neftalem",
    badgeID: "first_charge",
    progress: 1,
    completedAt: "Sep 14",
  },
  {
  ...
  {
    userID: "neftalem",
    badgeID: "squad_captain",
    progress: 3,
    completedAt: "Nov 21",
  },
  {
    userID: "neftalem",
    badgeID: "tower_conqueror",
    progress: 1,
    completedAt: "Dec 08",
  },
  {
    userID: "neftalem",
    badgeID: "frost_lancer",
    progress: 10,
    completedAt: "Jan 12",
  },
  {
